module github.com/nashlibby/gg

go 1.18

require (
	github.com/nashlibby/gutils v0.0.0-20220901061749-bcf0691d5841
	github.com/urfave/cli/v2 v2.11.2
)

require (
	github.com/BurntSushi/toml v1.2.0 // indirect
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1753 // indirect
